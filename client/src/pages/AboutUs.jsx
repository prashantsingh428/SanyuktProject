    ...
    return (
        <div className="bg-[#F8FAF5] font-sans">
            ...
            <section className="py-16 px-4 max-w-7xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[#0A7A2F] mb-4 animate-slide-up">
            ...
            <section className="py-16 px-4 max-w-7xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-[#0A7A2F] mb-12 animate-slide-up">
                    Our Core Values
                </h2>
