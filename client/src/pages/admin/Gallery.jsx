        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    {/* Main Card */}
                    <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-10 transform transition-all duration-500 hover:shadow-purple-200/50 animate-fade-in-up">
                        ...
                        >
                            ...
                            {!preview ? (
                                ...
                                >
                                    {/* Upload Icon */}
                                    <div className="w-24 h-24 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center animate-bounce-slow">
                                        <svg
                                ...
                                <div className="relative animate-fade-in">
                                    ...
                                    <div className="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-xl flex items-center justify-center space-x-4">
                                        ...
                                        <label
                                            htmlFor="image-upload"
                                            className="bg-purple-600 hover:bg-purple-700 text-white p-4 rounded-full transform transition-all duration-300 hover:scale-110 shadow-lg cursor-pointer"
                                            title="Change image"
                                        >
                                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Image Details */}
                        {preview && (
                            <div className="mt-6 p-4 bg-purple-50/50 rounded-xl animate-fade-in">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${!image || loading
                                        ...
                                        : "bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:shadow-purple-200"
                                    }
                                `}
                            >
                                {loading ? (
